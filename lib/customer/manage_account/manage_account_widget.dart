...
import '/customer/update_pic/update_pic_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> manageAccountUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final manageAccountUsersRecord = manageAccountUsersRecordList.isNotEmpty
            ? manageAccountUsersRecordList.first
            : null;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(45.0, 30.0, 0.0, 0.0),
