              ...
              children: [
                StreamBuilder<List<VoucherRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<VoucherRecord> listViewVoucherRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewVoucherRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewVoucherRecord =
                            listViewVoucherRecordList[listViewIndex];
                        return Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 20.0, 20.0, 0.0),
                          child: Card(
