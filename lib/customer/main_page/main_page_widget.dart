                                ...
                                child: StreamBuilder<List<RestaurantRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<RestaurantRecord>
                                        textFieldRestaurantRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final textFieldRestaurantRecord =
                                        textFieldRestaurantRecordList.isNotEmpty
                                            ? textFieldRestaurantRecordList
                                                .first
                                            : null;
                                    return TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'u67ti4v3' /* Search for restaurants */,
                                        ),
                      ...
                      if (_model.isShowFullList) {
                        return StreamBuilder<List<RestaurantRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<RestaurantRecord>
                                listViewRestaurantRecordList = snapshot.data!;
