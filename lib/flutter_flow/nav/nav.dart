...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AddToMenu',
          path: '/addToMenu',
          builder: (context, params) => const AddToMenuWidget(),
        ),
        FFRoute(
          name: 'Orders',
          path: '/orders',
        ...
        FFRoute(
          ...
          path: '/menu',
          asyncParams: {
            'restaurant': getDoc(['restaurant'], RestaurantRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          path: '/mealCustomization',
          asyncParams: {
            'food': getDoc(['Menu'], MenuRecord.fromSnapshot),
          },
          builder: (context, params) => MealCustomizationWidget(
        ...
        FFRoute(
          ...
          path: '/viewCart',
          asyncParams: {
            'addItem': getDoc(['restaurant'], RestaurantRecord.fromSnapshot),
          },
          builder: (context, params) => ViewCartWidget(
            addItem: params.getParam(
              'addItem',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'Reorder',
          path: '/reorder',
          builder: (context, params) => const ReorderWidget(),
        ),
        FFRoute(
          name: 'ManageAccount',
          path: '/manageAccount',
        ...
        FFRoute(
          name: 'UpdateMenu',
          path: '/updateMenu',
          builder: (context, params) => const UpdateMenuWidget(),
        ),
        FFRoute(
          name: 'LoginPage',
          path: '/loginPage',
        ...
        FFRoute(
          name: 'Inventories',
          path: '/inventories',
          builder: (context, params) => const InventoriesWidget(),
        ),
        FFRoute(
          name: 'UserAnalytics',
          path: '/userAnalytics',
          builder: (context, params) => const UserAnalyticsWidget(),
        ),
        FFRoute(
          name: 'chats',
          path: '/chats',
